      ...
      <section className="border-y border-white/10 bg-white/5">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 md:px-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-4 text-slate-300">
              Summit Logic delivers practical systems that fit how factories really
              operate: scanning workflows, local reliability, clean data capture,
              and reporting that helps managers act faster.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-cyan-400/20 bg-cyan-400/10 p-8" id="contact">
            ...
            <div className="mt-8 space-y-4 text-sm text-slate-100">
              <div>
                ...
                <div className="mt-1 text-base font-medium">summit.logic10@gmail.com</div>
              </div>
              <div>
